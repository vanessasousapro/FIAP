        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out.println(" Habilidade: " + personagem.habilidadeEspecial.nome + " Custo de energia: " + personagem.habilidadeEspecial.custoEnergia + " Habilitada? " + personagem.habilidadeEspecial.habilidade);
                    break;
                case 0:
